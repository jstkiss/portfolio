      ...
      >
        ...
        <div className="text-customsky justify-center flex pt-5">
          <p className="text-center">
            Actuellement à la recherche de nouvelles opportunités, ma boîte de
            réception est toujours ouverte. Que vous ayez une question ou que
            vous souhaitiez simplement dire bonjour, je n&apos;hésiterai pas à
